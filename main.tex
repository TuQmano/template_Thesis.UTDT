...
\subsection*{Apartado I} % El "*" en sub sección hace que la misma no sea tenida en cuenta para su numeración ni su indexación. 
 ...
 \begin{figure}[H]  
  \centering 
    \includegraphics[width=.6\textwidth]{CABA.png}
...
%  \begin{figure}[H]  ---->  posiciona la imagen en ese preciso lugar. Existe varias opciones para setear la posición de las imagenes -> https://stackoverflow.com/questions/518284/problem-with-float-and-pictures-in-latex#comment331982_518418 

%  \centering  ---->  centrar imagen

%  \includegraphics[width=.5\textwidth]{NombreImagen.png} ---->   Llama al archivo por su nombre.extensión (debe estar en la misma carpeta que .tex) + ajusta porcentualmente (.5) en este caso al tamaño del ancho del lugar de escritura


%   \caption{ ---->   Agrega texto de referencia debajo de la imagen

%   \label{ ---->  nombre corto de la imagen para llamarlo como referencia cruzada y crear tablas de figuras

%  \end{figure} ---->  Cerrar el espacio abierto para insertar figura


%%%%%%%%%%%%% RENEW COMMAND -> EJEMLPO %%%%



 \begin{figure}[H]  
  \centering 
    \includegraphics[width=\textwidth]{renew.png}
...
%  NOTA ======>   Si quisiéramos cambiar el encabezado que por default viene en la nota al pie ("Figure")  deberíamos poner en el preambulo :   
...
%En esta sección incluimos comando para citas múltiples en un mismo párrafo
 ...
 (\citealp{dunning_design-based_2010,brady_rethinking_2010,calvo_ballot_2009}).  % \citealp inserta referencias múltiples entre paréntesis automáticamente. Linkea con listado de referencias al final del texto. Del paquete natbib -> https://es.sharelatex.com/learn/Bibliography_management_with_natbib
